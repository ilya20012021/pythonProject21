...
def csv():
    ...
    if(h in u):
        mas = ["выбрать все данные(кнопка 1)","выбрать данные по условию столбца(кнопка 2)","выбрать данные по условиям столбцов(кнопка 3)","создать новый столбец с данными(кнопка 4)","внести данные(кнопка 5)"]
        mas1 = "/".join(mas)
